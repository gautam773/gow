		...
		<div class="row">
			...
			<div class="col-md-4">
				<form>
					...
					<address>
						<strong><h3>CBTR ONE NIIT-Coimbatore </h3></strong><br>3rd
						Floor,  Opp.G.Y.K Theatre,<br>  100Feet road, Coimbatore -
						268896<br> Phone: +91 7200586338<br> E-mail: <a
							href="mailto:#">gtmrockz773@gmail.com</a>
					</address>
				</form>
			</div>
		</div>
